...
public class Woo{
	...
	System.out.println("What kind of puzzle would you like to make? Input 1 for crossword and 2 for word search.");
	try{
	...
	if(_puzzlePick == 1){
		...
		System.out.println("The maximum number of word/clue pairs we recommended for best display is " + _currentMaxPairs + ". However, you may go above it.");
